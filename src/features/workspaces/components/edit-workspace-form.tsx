...
export const EditWorkSpaceForm = ({
  ...
  const handleResetInviteCode = async() =>{
    ...
    resetInviteCode({
      ...
      onSuccess:()=>{
        router.refresh() //this will refetch server component
      }
    })
    ...
    <Card className="w-full h-full border-none shadow-none">
      <CardContent className="p-7">
        <div className="flex flex-col">
          ...
          <DottedSeparator className="py-7" />
          <Button className="mt-6 w-fit ml-auto" size={"sm"} variant={"destructive"} type="button" disabled={isPending || isResettingInviteCode} onClick={handleResetInviteCode}>Reset Invite Link</Button>
        </div>
      </CardContent>
    </Card>
